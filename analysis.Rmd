...
library(ergm)
library(xtable)
BASE_PATH <- "~/math5005/msresearch/outputs/outputs/"
```
...
ecoli_sa_zeros <- load_rdata("ecoli2.Stochastic-Approximation.zeros")
ecoli_sa_zero_edges <- load_rdata("ecoli2.Stochastic-Approximation.zeros_and_edges")
ecoli_sa_mple <- load_rdata("ecoli2.Stochastic-Approximation.MPLE")
...
ecoli_ee_zeros <- load_rdata("ecoli2.EE.zeros")
ecoli_ee_zero_edges <- load_rdata("ecoli2.EE.zeros_and_edges")
ecoli_ee_mple <- load_rdata("ecoli2.EE.MPLE")
stats_ecoli_ee <- load_stats_rdata("ecoli2.EE.zeros", "ecoli2.EE.zeros_and_edges", "ecoli2.EE.MPLE")
# MCMLE
ecoli_mcmle_zeros <- load_rdata("ecoli2.MCMLE.zeros")
ecoli_mcmle_zero_edges <- load_rdata("ecoli2.MCMLE.zeros_and_edges")
ecoli_mcmle_mple <- load_rdata("ecoli2.MCMLE.MPLE")
...
# stochastic approximation
self_ecoli_sa_zeros <- load_rdata("ecoli2.self.study.Stochastic-Approximation.zeros")
self_ecoli_sa_zero_edges <- load_rdata("ecoli2.self.study.Stochastic-Approximation.zeros_and_edges")
self_ecoli_sa_mple <- load_rdata("ecoli2.self.study.Stochastic-Approximation.MPLE")
...
# equilibrium expectation
self_ecoli_ee_zeros <- load_rdata("ecoli2.self.study.EE.zeros")
self_ecoli_ee_zero_edges <- load_rdata("ecoli2.self.study.EE.zeros_and_edges")
self_ecoli_ee_mple <- load_rdata("ecoli2.self.study.EE.MPLE")
...
# MCMLE
self_ecoli_mcmle_zeros <- load_rdata("ecoli2.self.study.MCMLE.zeros")
self_ecoli_mcmle_zero_edges <- load_rdata("ecoli2.self.study.MCMLE.zeros_and_edges")
self_ecoli_mcmle_mple <- load_rdata("ecoli2.self.study.MCMLE.MPLE")
...
# stochastic approximation
kap1_sa_zeros <- load_rdata("kapferer.Stochastic-Approximation.zeros")
kap1_sa_zero_edges <- load_rdata("kapferer.Stochastic-Approximation.zeros_and_edges")
kap1_sa_mple <- load_rdata("kapferer.Stochastic-Approximation.MPLE")
...
# equilibrium expectation
kap1_ee_zeros <- load_rdata("kapferer.EE.zeros")
kap1_ee_zero_edges <- load_rdata("kapferer.EE.zeros_and_edges")
kap1_ee_mple <- load_rdata("kapferer.EE.MPLE")
stats_kap1_ee <- load_stats_rdata("kapferer.EE.zeros", "kapferer.EE.zeros_and_edges", "kapferer.EE.MPLE")
# MCMLE
# kap1_mcmle_zeros <- load_rdata("kapferer.MCMLE.zeros")
# kap1_mcmle_zero_edges <- load_rdata("kapferer.MCMLE.zeros_and_edges")
# kap1_mcmle_mple <- load_rdata("kapferer.MCMLE.MPLE")
...
```{r}
# stochastic approximation
kap2_sa_zeros <- load_rdata("kapferer2.Stochastic-Approximation.zeros")
kap2_sa_zero_edges <- load_rdata("kapferer2.Stochastic-Approximation.zeros_and_edges")
kap2_sa_mple <- load_rdata("kapferer2.Stochastic-Approximation.MPLE")
...
# equilibrium expectation
kap2_ee_zeros <- load_rdata("kapferer2.EE.zeros")
kap2_ee_zero_edges <- load_rdata("kapferer2.EE.zeros_and_edges")
kap2_ee_mple <- load_rdata("kapferer2.EE.MPLE")
...
# params_kap1 <- tabulate_parameters(params_kap1, stats_kap1_mcmle)
print.xtable(xtable(params_kap2), file = "~/math5005/msresearch/outputs/tables/kap2_params.txt")
print(params_kap2)
